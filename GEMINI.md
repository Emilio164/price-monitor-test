...
- **Inflation Analysis:** Historical tracking of "Dólar Blue" to detect real vs. nominal discounts.
...
## Completed Tasks ✅
1.  **Multi-Site Scrapers:** FullH4rd, Compragamer, and Diamond Computacion fully implemented and scalable.
...
3.  **Outlier Flagging:** Add a button to manually "unlink" products if the matching engine makes a mistake.
